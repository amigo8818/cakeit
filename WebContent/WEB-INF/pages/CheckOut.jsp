...
<body>
	...
	<a href="alipay.trade.page.pay.jsp">Confirm</a>
	...
	<form name=alipayment action=alipay.trade.page.pay.jsp method=post
		...
		<div id="body1" class="show" name="divcontent">
			<dl class="content">
				...
				<dt>付款金额 ：</dt>
				<dd>
					<input id="WIDtotal_amount" name="WIDtotal_amount" value=<%=fsum%> readonly="readonly" />
				</dd>
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDtotal_amount").value =<%=fsum%>;
	}
	GetDateNow();
</script>
</html>